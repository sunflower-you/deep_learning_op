...
void hamming(int &size, vector<float> &output, const int output_datatype=1, bool periodic=true)
{   
    vector<float> linspace_data;
    linspace(size, linspace_data, output_datatype);

    // float a0 = 25/46.0;  //  onnx
    float a0 = 0.54;  // torch
    float a1 = 1 - a0;
