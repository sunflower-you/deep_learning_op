...
void selu(vector<float> &input, vector<float> &output,  const float gamma=1.0507009873554804934193349852946, const float alpha=1.6732632423543772848170429916717)
{
    for(float x: input)
    {
        if (x <= 0)  output.push_back((exp(x) - 1) * alpha * gamma);
        else  output.push_back(x * gamma);
    }
}
